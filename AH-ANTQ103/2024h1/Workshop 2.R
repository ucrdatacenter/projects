...
# We will delve into ggplot in more detail in a later workshop, but for now we will use it to create a bar plot of the most common words. In the homework, adapt this code for your use-case.
...
# 4.1. Create a plot of the most common collections (The cities where the vases are kept) of the vases in a new dataset. Use the dataset from 1.1.

# 4.2. Create a plot of the most common collections of the vases in the original dataset. Use the dataset from 2.2. Create one plot that includes the top 10 vases from Cyprus and one plot that includes the top 10 vases from Greece.
