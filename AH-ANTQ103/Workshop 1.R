...
# 3. Functions
# 3.1. Sometimes it is useful to find the sum of a vector. We can do this using the sum function.
sum(x)
...
# 5.4. We can then use the print function to print the tibble.
print(tibble)

# 5.5. We can also look at the structure of the tibble using the View function. This will open a new window with the tibble. This is useful for looking at large data sets.
View(tibble)

# 5.6. We can also use the summary function to get a summary of the tibble. This gives some statistics about each numeric column.
summary(tibble)
